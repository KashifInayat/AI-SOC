...
# DVE full session
# Saved on Tue Jun 11 17:43:45 2019
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{65 80} {1890 1199}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 136} {height 872} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 223} {height 872} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1825} {height 140} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state minimized -rect {{74 87} {1917 1197}}
