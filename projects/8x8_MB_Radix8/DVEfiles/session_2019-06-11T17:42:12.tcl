...
# DVE full session
# Saved on Tue Jun 11 17:40:32 2019
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{65 52} {1891 1172}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 137} {height 872} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 224} {height 872} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 142]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1827
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 142
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1826} {height 141} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{74 87} {1918 1198}}
...
gui_show_window -window ${TopLevel.3} -show_state normal -rect {{76 118} {1915 1196}}
...
gui_sg_addsignal -group ${Group1} { test1.product test1.ce test1.mx test1.my test1.tmy }
gui_set_radix -radix {decimal} -signals {test1.ce}
gui_set_radix -radix {twosComplement} -signals {test1.ce}
set Group2 Group2
gui_sg_create ${Group2}
gui_sg_addsignal -group ${Group2} { test1.product test1.ce test1.p test1.mx test1.my test1.tmy }
gui_set_radix -radix {decimal} -signals {test1.ce}
gui_set_radix -radix {twosComplement} -signals {test1.ce}
