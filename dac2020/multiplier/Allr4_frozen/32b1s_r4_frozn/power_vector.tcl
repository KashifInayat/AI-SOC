...
set link_library "*  $stdcell_db_dir/saed32hvt_ss0p95v125c.db     $io_db_dir/saed32io_fc_ss0p95v125c_2p25v.db     $synthetic_library"
...
#aet bitwidth 8
#read_file -f verilog ./r4_16bit2s.v
#read_file -f verilog ./topdelay2s.v
#read_file -f verilog ./top.v 

read_file -f ddc  designs/postdc_netlistr42s1.ddc
#read_file -f verilog designs/postdc_netlistr42s1.v
current_design mb32_top

create_clock CLK -period 1.5

read_saif -input ./netlist.saif -instance test_m_booth_mult/uut1
