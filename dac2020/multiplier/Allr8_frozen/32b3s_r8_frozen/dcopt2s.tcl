...
#aet bitwidth 8
read_file -f verilog ./r8_32bit2s.v
read_file -f verilog ./mb32_td.v
...
set_dont_retime [get_cell uut/mx1*]
set_dont_retime [get_cell uut/my1*]
set_dont_retime [get_cell uut/product1*]
...
#set_dont_use {saed32hvt_ss0p95v125c/DFFSSRX2_HVT saed32hvt_ss0p95v125c/DFFSSRX1_HVT saed32hvt_ss0p95v125c/DFFASX1_HVT saed32hvt_ss0p95v125c/DFFASX2_HVT }
optimize_registers
...
write_file -f verilog -hier -output designs/postdc_netlistr82s.v
...
write_file -f ddc -hier -output designs/postdc_netlistr82s.ddc

report_timing
report_timing > $final_reports_dir/delay.txt
current_design mb32_td
report_area
